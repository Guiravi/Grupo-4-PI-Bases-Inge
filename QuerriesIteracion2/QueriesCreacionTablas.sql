...
(
	...
	nombreRolFK NVARCHAR(25) CONSTRAINT DF_Miembro_nombreRolFK DEFAULT 'Periférico'
...
(
	...
	CONSTRAINT FK_NucleoRevisaArticulo_Articulo FOREIGN KEY (idArticuloFK) REFERENCES Articulo(idArticuloPK)
		ON DELETE CASCADE --Se borran todas las revisiones asociadas al artículo borrado.
		ON UPDATE CASCADE
);
